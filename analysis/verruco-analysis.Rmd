...
grid.text("Verrucomicrobia Community", rot=90, vp=viewport(layout.pos.row=2, layout.pos.col=1), gp=gpar(fontsize=10,fontface="bold"))
grid.text("Non-Verrucomicrobia Community", rot=90, vp=viewport(layout.pos.row=3, layout.pos.col=1), gp=gpar(fontsize=10,fontface="bold"))
