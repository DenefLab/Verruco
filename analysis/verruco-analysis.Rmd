...
scaled <- scale_reads(dupmerge.subset,min(sample_sums(dupmerge.subset)))
  ### Scaled to 13,012 (minumum sample)
    # 28,759 taxa
    # 219 samples
...
Ver.lau.ord <- plot_ordination(physeq = Ver.lau, ordination = Ver.lau.pcoa, axes = c(1, 3),
                title= "Bray-Curtis Dissimilarity") + 
...
Ver.est.ord <- plot_ordination(physeq = Ver.est, ordination = Ver.est.pcoa, axes = c(1, 3),
                title= "Bray-Curtis Dissimilarity") + 
  geom_point(size=2, aes(color = Season, shape = Depth,
                         fill = factor(ifelse(Fraction == "Free", NA, Season)),
                         alpha = Fraction)) +
...
Ver.inl.ord <- plot_ordination(physeq = Ver.inl, ordination = Ver.inl.pcoa, axes = c(1, 3),
                title= "Bray-Curtis Dissimilarity") + 
  geom_point(size=2, aes(color = Season, shape = Depth,
                         fill = factor(ifelse(Fraction == "Free", NA, Season)),
                         alpha = Fraction)) +
...
tiff("remain.pcoa.tiff", width = 14, height = 10, units = "in", res = 500)
grid.newpage()
pushViewport(viewport(layout=(grid.layout(1,3, widths=c(1,1,1), heights=c(1.5,1.5,1.5)))))
...
adonis(Ver.bray ~ Depth, data=sampledf)
  ## R2 = 0.12755
  ## p-value = 0.001
beta.tax = betadisper(d=Ver.bray, Lake_Type=sampledf$Depth)
...
adonis(adonis.tb.bray ~ Depth, data=adonis.tb)
  # p-value = 0.003
  # R2 = 0.01201
beta.tax = betadisper(d=adonis.tb.bray, Lake_Type=adonis.tb$Depth)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.317
  # F = 1.021386
...
adonis(adonis.ts.bray ~ Depth, data=adonis.ts)
  # p-value = 0.001
  # R2 = 0.19255
beta.tax = betadisper(d=adonis.ts.bray, Lake_Type=adonis.ts$Depth)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 48.59091
...
adonis(adonis.bs.bray ~ Depth, data=adonis.bs)
  # p-value = 0.001
  # R2 = 0.18178
beta.tax = betadisper(d=adonis.bs.bray, Lake_Type=adonis.bs$Depth)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 46.04348 
...
adonis(adonis.scaled.le.bray ~ Lake_Type, data=adonis.scaled.le)
  # p-value = 0.001
  # R2 = 0.07658 
beta.tax = betadisper(d=adonis.scaled.le.bray, Lake_Type=adonis.scaled.le$Lake_Type)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.081
  # F = 3.716424
...
adonis(adonis.scaled.li.bray ~ Lake_Type, data=adonis.scaled.li)
  # p-value = 0.001
  # R2 = 0.07212
beta.tax = betadisper(d=adonis.scaled.li.bray, Lake_Type=adonis.scaled.li$Lake_Type)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 13.47688
...
adonis(adonis.scaled.ei.bray ~ Lake_Type, data=adonis.scaled.ei)
  # p-value = 0.001
  # R2 = 0.07689
beta.tax = betadisper(d=adonis.scaled.ei.bray, Lake_Type=adonis.scaled.ei$Lake_Type)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.96
  # F = 0.002008325
...
adonis(adonis.pf.bray ~ Fraction, data=adonis.pf)
  # p-value = 0.001
  # R2 = 0.09799
beta.tax = betadisper(d=adonis.pf.bray, Lake_Type=adonis.pf$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 27.67899
...
adonis(adonis.ps.bray ~ Fraction, data=adonis.ps)
  # p-value = 0.001
  # R2 = 0.17335
beta.tax = betadisper(d=adonis.ps.bray, Lake_Type=adonis.ps$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 49.36893
...
adonis(adonis.fs.bray ~ Fraction, data=adonis.fs)
  # p-value = 0.001
  # R2 = 0.24494
beta.tax = betadisper(d=adonis.fs.bray, Lake_Type=adonis.fs$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 15.73037
...
adonis(adonis.ss.bray ~ Season, data=adonis.ss)
  # p-value = 0.001
  # R2 = 0.09052
beta.tax = betadisper(d=adonis.ss.bray, Lake_Type=adonis.ss$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 18.84919
...
adonis(adonis.sf.bray ~ Season, data=adonis.sf)
  # p-value = 0.001
  # R2 = 0.1431
beta.tax = betadisper(d=adonis.sf.bray, Lake_Type=adonis.sf$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 27.70226
...
adonis(adonis.suf.bray ~ Season, data=adonis.suf)
  # p-value = 0.001
  # R2 = 0.0301
beta.tax = betadisper(d=adonis.suf.bray, Lake_Type=adonis.suf$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 15.59481
...
##### Nested adonis #####
adonis(Ver.bray ~ Depth + Lake_Type + Fraction + Season, data = sampledf)
  ## Depth & Lake_Type have highest R2 (0.12755 & 0.11110 respectively)
  ## Fraction (0.08329), Season (0.08176)
  ## Residuals = 0.59631 
  ## All p-values = 0.001

## Raw data explains 0.361 (R2)
  # Lake_Type, Depth, Fraction, Season (in order of R2)
...
scaled.lau.ord <- plot_ordination(physeq = scaled.lau, ordination = scaled.lau.pcoa, axes = c(1, 3),
                title= "Bray-Curtis Dissimilarity") + 
  geom_point(size=2, aes(color = Season, shape = Depth,
                         fill = factor(ifelse(Fraction == "Free", NA, Season)),
                         alpha = Fraction)) +
...
scaled.inl.ord <- plot_ordination(physeq = scaled.inl, ordination = scaled.inl.pcoa, axes = c(1, 3),
                title= "Bray-Curtis Dissimilarity") + 
  geom_point(size=2, aes(color = Season, shape = Depth,
                         fill = factor(ifelse(Fraction == "Free", NA, Season)),
                         alpha = Fraction)) +
...
tiff("remain.bcc.pcoa.tiff", width = 14, height = 10, units = "in", res = 500)
grid.newpage()
pushViewport(viewport(layout=(grid.layout(1,3, widths=c(1,1,1), heights=c(1.5,1.5,1.5)))))
...
adonis(scaled.bray ~ Depth, data=bcc.sampledf)
  ## R2 = 0.12468
  ## p-value = 0.001
beta.tax = betadisper(d=scaled.bray, Lake_Type=bcc.sampledf$Depth)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 11.40066 
...
adonis(adonis.scaled.tb.bray ~ Depth, data=adonis.scaled.tb)
  # p-value = 0.001
  # R2 = 0.01989
beta.tax = betadisper(d=adonis.scaled.tb.bray, Lake_Type=adonis.scaled.tb$Depth)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.002
  # F = 11.99703
...
adonis(adonis.scaled.ts.bray ~ Depth, data=adonis.scaled.ts)
  # p-value = 0.001
  # R2 = 0.18956
beta.tax = betadisper(d=adonis.scaled.ts.bray, Lake_Type=adonis.scaled.ts$Depth)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.003
  # F = 8.363528 
...
adonis(adonis.scaled.bs.bray ~ Depth, data=adonis.scaled.bs)
  # p-value = 0.001
  # R2 = 0.15569 
beta.tax = betadisper(d=adonis.scaled.bs.bray, Lake_Type=adonis.scaled.bs$Depth)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 20.21171 
...
adonis(adonis.ei.bray ~ Lake_Type, data=adonis.ei)
  # p-value = 0.001
  # R2 = 0.07067
beta.tax = betadisper(d=adonis.ei.bray, Lake_Type=adonis.ei$Lake_Type)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.961
  # F = 0.002008325 
...
adonis(adonis.scaled.pf.bray ~ Fraction, data=adonis.scaled.pf)
  # p-value = 0.001
  # R2 = 0.13634
beta.tax = betadisper(d=adonis.scaled.pf.bray, Lake_Type=adonis.scaled.pf$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 106.0687 
...
adonis(adonis.scaled.ps.bray ~ Fraction, data=adonis.scaled.ps)
  # p-value = 0.001
  # R2 = 0.15058
beta.tax = betadisper(d=adonis.scaled.ps.bray, Lake_Type=adonis.scaled.ps$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 29.2068 
...
adonis(adonis.scaled.fs.bray ~ Fraction, data=adonis.scaled.fs)
  # p-value = 0.001
  # R2 = 0.26093
beta.tax = betadisper(d=adonis.scaled.fs.bray, Lake_Type=adonis.scaled.fs$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.855
  # F = 0.02365651
...
adonis(adonis.scaled.ss.bray ~ Season, data=adonis.scaled.ss)
  # p-value = 0.001
  # R2 = 0.07834
beta.tax = betadisper(d=adonis.scaled.ss.bray, Lake_Type=adonis.scaled.ss$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 51.59802
...
adonis(adonis.scaled.sf.bray ~ Season, data=adonis.scaled.sf)
  # p-value = 0.001
  # R2 = 0.09675 
beta.tax = betadisper(d=adonis.scaled.sf.bray, Lake_Type=adonis.scaled.sf$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 22.58511 
...
adonis(adonis.scaled.suf.bray ~ Season, data=adonis.scaled.suf)
  # p-value = 0.001
  # R2 = 0.03054
beta.tax = betadisper(d=adonis.scaled.suf.bray, Lake_Type=adonis.scaled.suf$Fraction)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.001
  # F = 29.63419
...
##### Nested adonis #####
adonis(scaled.bray ~ Depth + Fraction + Lake_Type + Season, data = bcc.sampledf)
  ## Depth & Fraction have highest R2 (0.12468 & 0.11545 respectively)
  ## Lake_Type (0.09573), Season ( 0.06651)
  ## Residuals = 0.59763 
  ## All p-values = 0.001
