...
Ver.box <- data.frame(sample_data(Ver.box))
Ver.box$Relative_Abundance <- data.frame(otu_table(Ver.box.phy))
...
### Plotting Time!
ggplot(final.stats, aes(x = Lake_frac, y = mean)) +
  geom_point(size = 3, alpha = 0.7) +
  geom_errorbar(aes(ymin= Mean-SD, ymax=Mean+SD), color = "black", width=.1,
                position=position_dodge(0.9)) +
  layer(data = final.stats, mapping=aes(x=Lake_frac, y=Median), geom="point")
