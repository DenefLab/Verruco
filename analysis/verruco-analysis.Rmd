...
bioenv.est <- bioenv(est.otus ~ Temperature..C. + SpCond...S.cm. + TDS..mg.L. +
                       ...
                       TP.ug.L + Alk.mg.L + DO.Lab.mg.L + DO.Lab.mg.L + Turb.NTU, est.env,
...
while (x < 100){
  ...
  x <- x + 1
  bioenv.rand <- bioenv(est.otus.rand ~ Temperature..C. + SpCond...S.cm. + TDS..mg.L. +
                       pH + ORP..mV. + Chl.Lab..ug.L. + BGA.cells.mL + Cl.mg.L +
                       SO4.mg.L + NO3.mg.L + NH3.mg.L + TKN.mg.L + SRP.ug.L +
                       TP.ug.L + Alk.mg.L + DO.Lab.mg.L + DO.Lab.mg.L + Turb.NTU, est.env,
                     method = "spearman", index = "bray", trace =TRUE, partial=NULL)
...
while (x < 100){
  ...
  x <- x + 1
  bioenv.rand <- bioenv(inl.otus.rand ~ Chl.Lab..ug.L. + NO3.mg.L + SRP.ug.L + TP.ug.L +
                       TDP.ug.L + NH4.ug.L, inl.env, method = "spearman",
                     index = "bray", trace = TRUE, partial = NULL)
  tmp <- data.frame(summary(bioenv.rand)[2])
