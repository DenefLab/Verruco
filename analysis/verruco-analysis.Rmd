...
# Remove phyla that are <0.1% rel abun (median) in all 3 Lake Types
...
##### PLOT #####
tiff("phy.relabund.tiff", width = 10, height = 15, units = "cm", res = 600)
ggplot(phy.trim, aes(x=Phylum, y=Median, fill=Phylum)) +
  ...
  xlab("Phyla") + ylab("Median Relative Abundance (Taxa > 0.1%)") +
...
seas.box <- ggplot(Ver.box, aes(x=Lake_Type, y=Relative_Abundance, fill=Season)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=10),
        ...
        strip.text.x = element_blank(),
        plot.margin = unit(c(0.1, -0.1, 0.1, 0.1), "cm")) + # top, right, bottom, left
  geom_text(data = ann_text, aes(label=lab), x=c(1,1,1.33), y=c(41,41,27), size=4, color="red")
...
inv.simp.frac.plot <- ggplot(inv.simp, aes(x=Lake_Type, y=mean, fill=Fraction)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=10),
        ...
        strip.text.x = element_blank(),
        plot.margin = unit(c(0.1, -0.1, 0.1, 0.1), "cm")) + # top, right, bottom, left
  geom_text(data = ann.frac, aes(x = c(1,1.33,1), y=c(15.6, 15.9, 15.6), label = lab), size = 4, color="red")
...
inv.simp.seas.plot <- ggplot(inv.simp, aes(x=Lake_Type, y=mean, fill=Season)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=10),
        ...
        strip.text.x = element_blank(),
        plot.margin = unit(c(0.1, -0.1, 0.1, 0.1), "cm")) + # top, right, bottom, left
  geom_text( data = ann.seas, aes(x=c(1,1,1), y=c(14,13.7,14), label=lab), size=4, color="red")
...
pd.seas.plot <- ggplot(final.pd, aes(x=Lake_Type, y=Stat, fill=Season)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=10),
        ...
        strip.text.x = element_blank(),
        plot.margin = unit(c(0.1, -0.1, 0.1, 0.1), "cm")) + # top, right, bottom, left
  geom_text(data = ann.pd.seas, aes(x = c(1.33,1,0.67,1), y=c(2,1,3.1,3.1), label = lab), size = 4, color="red")


##### Combine PD Plots #####
png("pd.png", width = 17.8, height = 7, units = "cm", res = 600)
grid.newpage()
