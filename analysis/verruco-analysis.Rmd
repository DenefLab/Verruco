...
##### Adjust P-Values #####
pd.kw.vals <- data.frame(c(2.616e-05, 0.9906, 2.539e-06, 0.0004496, 3.932e-09, 2.558e-05, 0.0001398, 1.231e-06, 4.635e-05, 0.002038, 1.067e-07, 0.02786, 0.06875, 0.3741, 6.1e-05, 2.389e-05, 0.0007715, 1, 0.9316,  0.06256, 0.5188, 0.2539, 0.01932, 7.962e-06, 0.0987, 0.1273, 0.0001166, 4.635e-05, 0.2154, 0.001097, 2.445e-05, 0.3926))
...
# Convert tree into distance matrix
phy.dist <- cophenetic(ver.tree)

# Calculate SES.MPD
comm.sesmpd <- ses.mpd(picante.com,phy.dist, null.model = "taxa.labels", 
