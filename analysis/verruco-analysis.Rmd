...
pd.frac.plot <- ggplot(final.pd, aes(x=Lake_Type, y=Stat, fill=Fraction)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=10),
        ...
        strip.text.x = element_blank(),
        plot.margin = unit(c(0.1, -0.1, 0.1, 0.1), "cm")) + # top, right, bottom, left
  geom_text(data = ann.pd.frac, aes(x = c(1,1.35,1), y=c(5, 5, 5), label = lab), size = 6, color="red")
...
##### Adjust P-Values #####
pd.kw.vals <- data.frame(c(0.1137, 0.1192, 0.07596, 0.7314, 3.932e-09, 0.03951, 0.09885, 1.308e-06, 1.374e-06, 0.02507, 3.859e-06, 1.999e-05, 0.4808, 0.8721, 3.045e-05, 0.0001352, 8.607e-05, 0.3557, 0.822, 0.08661, 0.2661, 0.02478, 0.08827, 2.332e-05, 0.6679, 0.3743, 7.646e-06, 1.374e-06, 0.5619, 1.153e-05, 6.985e-06, 0.5098))
colnames(pd.kw.vals) <- "pvals"
pd.kw.vals$Lake <- c("All", "EI", "LI", "LE", "All", "All", "L", "E", "E", "E", "E", "E", "I", "All", "L", "L", "L", "L", "E", "I", "I", "I", "I", "All", "All", "L", "E", "E", "E", "E", "E", "I")
pd.kw.vals$Comp <- c("Lake", "EI", "LI", "LE", "Frac", "PF", "Frac", "Frac", "Source", "PF", "FS", "PS", "Frac", "Seas", "Seas", "SuFa", "SpFa", "Spsu", "Seas", "Seas", "SuFa", "SpFa", "SpSu", "Depth", "TB", "Depth", "Depth", "Source", "TB", "BS", "TS", "Depth")
...
##### Adjust P-Values #####
mpd.kw.vals <- data.frame(c(3.611e-06, 0.001532, 0.005122, 0.7314, 6.903e-14, 5.05e-09, 0.02699, 1.543e-06, 5.134e-07, 0.1585, 1.755e-06, 8.267e-06, 1.72e-08, 0.7346, 0.003229, 0.05634, 0.001819, 0.05628, 0.8828, 0.02586, 0.5843, 0.03064, 0.009947, 4.23e-07, 0.7764, 0.1021, 2.083e-06, 5.134e-07, 0.2426, 4.527e-06, 3.316e-06, 0.1965))
colnames(mpd.kw.vals) <- "pvals"
mpd.kw.vals$Lake <- c("All", "EI", "LI", "LE", "All", "All", "L", "E", "E", "E", "E", "E", "I", "All", "L", "L", "L", "L", "E", "I", "I", "I", "I", "All", "All", "L", "E", "E", "E", "E", "E", "I")
mpd.kw.vals$Comp <- c("Lake", "EI", "LI", "LE", "Frac", "PF", "Frac", "Frac", "Source", "PF", "FS", "PS", "Frac", "Seas", "Seas", "SuFa", "SpFa", "Spsu", "Seas", "Seas", "SuFa", "SpFa", "SpSu", "Depth", "TB", "Depth", "Depth", "Source", "TB", "BS", "TS", "Depth")
