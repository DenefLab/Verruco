...
pd.frac.plot <- ggplot(final.pd, aes(x=Lake_Type, y=Stat, fill=Fraction)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=10),
        ...
        strip.text.x = element_blank(),
        plot.margin = unit(c(0.1, -0.1, 0.1, 0.1), "cm")) + # top, right, bottom, left
  geom_text(data = ann.pd.frac, aes(x = c(1,1.35,1), y=c(5, 5, 5), label = lab), size = 4, color="red")
...
mpd.frac.plot <- ggplot(final.mpd, aes(x = Lake_Type, y = Stat, fill = Fraction)) + 
  ...
  geom_text(data = ann.mpd.frac, aes(x = c(1,1.35,1), y=c(5, 5, 5), label = lab), size = 6, color="red")
...
mpd.seas.plot <- ggplot(final.mpd, aes(x=Lake_Type, y=Stat, fill=Season)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=10),
        ...
        strip.text.x = element_blank(),
        plot.margin = unit(c(0.1, -0.1, 0.1, 0.1), "cm")) + # top, right, bottom, left
  geom_text(data = ann.mpd.seas, aes(x = c(0.65,1.35,1,0.65), y=c(5.15,5.15,5.15,5.15), label = lab), size = 4, color="red")
