...
### Plot Comparisons ###
tiff("Fig_S1.tiff", width = 15, height = 5, units = "cm", res = 600)
grid.newpage()
...
tiff("Fig_S2.tiff", width = 17.4, height = 18, units = "cm", res = 600)
...
#tiff("Fig_S6.tiff", width = 17.4, height = 18, units = "cm", res = 600)
...
tiff("Fig_2.tiff", width = 17.4, height = 10, units = "cm", res = 600)
grid.newpage()
...
#lau.y <- lau.y[-7]
dev.new()
tiff("residuals.lau.tiff", width = 15, height = 6, units = "cm", res = 600)
grid.newpage()
...
dev.new()
tiff("residuals.est.tiff", width = 15, height = 6, units = "cm", res = 600)
grid.newpage()
...
dev.new()
tiff("residuals.inl.tiff", width = 15, height = 6, units = "cm", res = 600)
grid.newpage()
...
##### PLOT!!! #####
dev.new()
tiff("Fig_S3.tiff", width = 15, height = 18, units = "cm", res = 600)
grid.newpage()
pushViewport(viewport(layout=(grid.layout(3,1))))
print("residuals.lau.tiff", vp=viewport(layout.pos.row=1, 
                                                                  layout.pos.col=1))
print("residuals.est.tiff", vp=viewport(layout.pos.row=2, 
                                                                  layout.pos.col=1))
print("residuals.inl.tiff", vp=viewport(layout.pos.row=3, 
                                                                  layout.pos.col=1))
dev.off()
...
######## Plot MPD ########
tiff("Fig_S4.tiff", width = 17.4, height = 5, units = "cm", res = 600)
grid.newpage()
...
nonver.est.ord <- plot_ordination(physeq = nonver.est, ordination = nonver.est.pcoa, axes = c(1, 2),
  ...
  theme(axis.text.x = element_blank(), 
        ...
        plot.title = element_text(size = 9, face="bold", hjust=0.5)) +
  scale_y_reverse() +
  annotate("text", x= -0.63, y=-0.23, label = "E", fontface = "bold", size=5, colour="black") +
  guides(colour=FALSE, shape=FALSE, alpha = FALSE) 
...
### Big PCoA Figure
```{r}
tiff("Fig_3.tiff", width = 17.4, height = 12, units = "cm", res = 600)
...
grid.text("Laurentian", just=c(0.35, 0.5), vp=viewport(layout.pos.row=1, layout.pos.col=2), gp=gpar(fontsize=9,fontface="bold"))
grid.text("Estuary", just=c(0.35, 0.5), vp=viewport(layout.pos.row=1, layout.pos.col=3), gp=gpar(fontsize=9,fontface="bold"))
grid.text("Inland",  just=c(0.35, 0.5), vp=viewport(layout.pos.row=1, layout.pos.col=4), gp=gpar(fontsize=9,fontface="bold"))
grid.text("Verrucomicrobia Community", rot=90, vp=viewport(layout.pos.row=2, layout.pos.col=1), gp=gpar(fontsize=9,fontface="bold"))
grid.text("Non-Verrucomicrobia Community", rot=90, vp=viewport(layout.pos.row=3, layout.pos.col=1), gp=gpar(fontsize=9,fontface="bold"))
